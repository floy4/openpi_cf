...
def eval_libero(args: Args) -> None:
        ...
        for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
            ...
            if cf_metrics_history:
                ...
                cf_metrics_path.write_text(json.dumps({
                    ...
                    "success": done,
                    "cf_metrics_history": cf_metrics_history,
                }, indent=2))
                logging.info(f"CF metrics saved to {cf_metrics_path}")
    ...
    stats_path = pathlib.Path(args.video_out_path) / "results.txt"
